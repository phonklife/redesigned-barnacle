...
<head>
    ...
    <style>
        ...
        :root {{
            --bg: #08090d;
            --bg-elevated: rgba(12, 13, 18, 0.84);
            --panel: rgba(15, 17, 23, 0.92);
            --panel-soft: rgba(18, 20, 28, 0.74);
        ...
        body {{
            ...
            background:
                radial-gradient(circle at top left, rgba(180, 124, 255, 0.18), transparent 38%),
                radial-gradient(circle at bottom right, rgba(244, 114, 182, 0.12), transparent 32%),
                var(--bg);
            color: var(--text);
        }}
        ...
        .site-shell {{
            min-height: 100vh;
            background: linear-gradient(180deg, rgba(8, 9, 13, 0.88), rgba(8, 9, 13, 1));
        }}
        ...
        .brand-mark {{
            ...
            box-shadow: 0 12px 25px rgba(180, 124, 255, 0.35);
            display: inline-flex;
            align-items: center;
        ...
        .brand-copy h1 {{
            ...
            font-weight: 700;
            background: linear-gradient(90deg, #f5f5f7, #d8b4fe, #f9a8d4);
        ...
        .hero-panel {{
            background: linear-gradient(180deg, rgba(16, 18, 24, 0.9), rgba(12, 13, 18, 0.75));
        ...
        .hero-panel::before {{
            ...
            width: 300px;
            height: 300px;
            background: radial-gradient(circle, rgba(180,124,255,.18), transparent 60%);
            pointer-events: none;
        }}
        ...
        .eyebrow {{
            ...
            align-items: center;
            gap: 8px;
            border: 1px solid rgba(180, 124, 255, 0.25);
            background: rgba(180, 124, 255, 0.07);
            color: #e2d6ff;
            border-radius: 999px;
            padding: 7px 12px;
            font-size: 0.68rem;
        ...
        .primary-btn {{
            background: linear-gradient(135deg, var(--accent), var(--accent-strong));
            color: white;
            box-shadow: 0 16px 30px rgba(180,124,255,0.28);
        }}
        ...
        .stat-card .tag {{
            ...
            padding: 4px 8px;
            border-radius: 999px;
            background: rgba(136, 240, 194, 0.08);
            color: var(--good);
            font-size: 0.7rem;
            font-weight: 600;
        }}
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {{
            background: rgba(180, 124, 255, 0.4);
            border-radius: 3px;
        }}
        .custom-scrollbar::-webkit-scrollbar-thumb:hover {{
            background: rgba(180, 124, 255, 0.7);
        }}
        .neon-border {{
            box-shadow: 0 0 15px rgba(168, 85, 247, 0.12);
        }}
        .neon-glow-pink, .neon-glow-purple {{
            box-shadow: 0 0 20px rgba(236, 72, 153, 0.28), 0 0 40px rgba(168, 85, 247, 0.18);
        }}
...
<body class="site-shell text-zinc-100 flex flex-col min-h-screen">
        ...
        <div class="site-header-inner">
            <div class="flex items-center gap-3">
                ...
                <div class="brand-copy">
                    <h1>Suno-Archive-Automator</h1>
                    <p>virtualluser / musical system atlas</p>
                </div>
            </div>
            <div class="flex items-center gap-4">
                <a href="https://github.com/phonklife/redesigned-barnacle" target="_blank" class="header-pill">
    ...
    <div class="page-shell">
        <section class="hero-panel">
            <div class="hero-copy">
                <span class="eyebrow"><i data-lucide="sparkles" class="w-3.5 h-3.5"></i> minimal flow system</span>
                <h2>Sound, structure, and story in one clean archive.</h2>
                <p>
                    A modern music research interface for virtualluser — built as a minimalist visual dashboard that keeps the energy of the sound while staying calm, premium, and focused.
                </p>
                <div class="hero-actions">
                    <a href="#track-list" class="primary-btn"><i data-lucide="play" class="w-4 h-4"></i> Explore archive</a>
                    <a href="#network-canvas" class="secondary-btn"><i data-lucide="network" class="w-4 h-4"></i> Open map</a>
                </div>
            </div>
            <div class="stats-panel">
                <div class="stat-card">
                    <span class="value">{track_count}</span>
                    <span class="label">tracks</span>
                    <span class="tag">live catalog</span>
                </div>
                <div class="stat-card">
                    <span class="value">{motif_count}</span>
                    <span class="label">motifs</span>
                    <span class="tag">mapped</span>
                </div>
                <div class="stat-card">
        ...
        <!-- Main Content -->
        <main class="flex-grow w-full grid grid-cols-1 lg:grid-cols-12 gap-6">
        
        <!-- Left Column: Player & Track List (5 cols) -->
        <div class="lg:col-span-5 flex flex-col gap-6 min-h-[500px] lg:min-h-[620px]">
        ...
        <div class="lg:col-span-7 flex flex-col gap-6 min-h-[500px] lg:min-h-[620px]">
